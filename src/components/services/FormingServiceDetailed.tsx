  ...
  return (
    <>
      <style>{`
        ...
        .fm-hero-title { font-size: clamp(1.8rem,3.5vw,2.6rem); font-weight: 900; color: #0f0824; letter-spacing: -0.5px; margin-bottom: 14px; }
        .fm-hero-desc { font-size: 1rem; color: #6b6b80; max-width: 540px; margin: 0 auto 28px; line-height: 1.75; }
        .fm-hero-btn {
          display: inline-flex; align-items: center; gap: 8px;
        ...
        .fm-hero-btn:hover { background: #ab8cf5; color: #281750; transform: translateY(-2px); box-shadow: 0 6px 20px rgba(171,140,245,0.35); }
